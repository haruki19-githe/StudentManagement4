INSERT INTO students (id,name,furigana,nickname,email,area,age,gender,remark,is_deleted)VALUES
('1','山田太朗','ヤマダタロウ','タロ','taro@example.com','東京',25,'男性','',false),
('2','鈴木一郎','スズキイチロウ','イチ','ichiro@example.com','仙台',35,'女性','',false),
('3','田中花子','タナカハナコ','ハナ','hanako@example.com','神奈川',45,'男性','',false),
('4','佐藤良子','サトウリョウコ','リョウ','ryoko@example.com','山梨',55,'女性','',false),
('5','伊藤悠','イトウハルカ','ハル','haruka@example.com','静岡',15,'その他','',false);
